...
it('should not notify the publisher if the exclude_me options is set', function(done) {
                ...
                function onevent2(args) {
                    ...
                    if (received > 5) {
                        ...
                        if (session1Received === false) {
                            assert(true, "Case 1: Publisher did not receive any events!");
                        } else {
                            assert(false, "Case 1: Publisher received one or more events!");
                        }
            ...
            function case2() {
                ...
                function onevent2(args) {
                    ...
                    if (received > 5) {
                        ...
                        if (!session1Received) {
                            assert(true, "Case 2: Publisher did not receive any events!");
                        } else {
                            assert(false, "Case 2: Publisher received one or more events!");
                        }
